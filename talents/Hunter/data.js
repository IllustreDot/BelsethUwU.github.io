...
talent[i] = [0, "Improved Aspect of the Hawk", 5, 2, 1];
i++;
talent[i] = [0, "Endurance Training", 5, 3, 1];
i++;
talent[i] = [0, "Focused Fire", 2, 1, 2];
i++;
talent[i] = [0, "Improved Aspect of the Monkey", 3, 2, 2];
i++;
talent[i] = [0, "Thick Hide", 3, 3, 2];
i++;
talent[i] = [0, "Improved Revive Pet", 2, 4, 2];
i++;
talent[i] = [0, "Pathfinding", 2, 1, 3,];
i++;
talent[i] = [0, "Aspect Mastery", 1, 2, 3];
i++;
talent[i] = [0, "Unleashed Fury", 5, 3, 3];
i++;
talent[i] = [0, "Animal's Mind", 1, 1, 4, [getTalentID("Pathfinding"), 2]];
i++;
talent[i] = [0, "Improved Mend Pet", 2, 2, 4];
i++;
talent[i] = [0, "Ferocity", 5, 3, 4];
i++;
talent[i] = [0, "Spirit Bond", 2, 1, 5];
i++;
talent[i] = [0, "Intimidation", 1, 2, 5];
i++;
talent[i] = [0, "Bestial Discipline", 2, 4, 5];
i++;
talent[i] = [0, "Animal Handler", 2, 1, 6];
i++;
talent[i] = [0, "Frenzy", 5, 3, 6, [getTalentID("Ferocity"), 5]];
i++;
talent[i] = [0, "Ferocious Inspiration", 3, 1, 7];
i++;
talent[i] = [0, "Bestial Wrath", 1, 2, 7, [getTalentID("Intimidation"), 1]];
i++;
talent[i] = [0, "Catlike Reflexes", 3, 3, 7];
i++;
talent[i] = [0, "Invigoration", 2, 1, 8, [getTalentID("Ferocious Inspiration"), 3]];
i++;
talent[i] = [0, "Serpent's Swiftness", 5, 3, 8];
i++;
talent[i] = [0, "Longevity", 3, 1, 9];
i++;
talent[i] = [0, "The Beast Within", 1, 2, 9, [getTalentID("Bestial Wrath"), 1]];
i++;
talent[i] = [0, "Cobra Strikes", 3, 3, 9, [getTalentID("Serpent's Swiftness"), 5]];
i++;
talent[i] = [0, "Cobra Charmer", 1, 4, 9, [getTalentID("Cobra Strikes"), 1]];
i++;
talent[i] = [0, "Kindred Spirits", 5, 2, 10];
i++;
talent[i] = [0, "Beast Mastery", 1, 2, 11];
i++;
...
talent[i] = [1, "Improved Concussive Shot", 2, 1, 1];
i++;
talent[i] = [1, "Focused Aim", 3, 2, 1];
i++;
talent[i] = [1, "Lethal Shots", 5, 3, 1];
i++;
talent[i] = [1, "Careful Aim", 3, 1, 2];
i++;
talent[i] = [1, "Improved Hunter's Mark", 3, 2, 2];
i++;
talent[i] = [1, "Mortal Shots", 5, 3, 2];
i++;
talent[i] = [1, "Go for the Throat", 2, 1, 3];
i++;
talent[i] = [1, "Improved Arcane Shot", 3, 2, 3];
i++;
talent[i] = [1, "Aimed Shot", 1, 3, 3, [getTalentID("Mortal Shots"), 5]];
i++;
talent[i] = [1, "Rapid Killing", 2, 4, 3];
i++;

const poisonousShotsId = i;
talent[i] = [1, "Poisonous Shots", 1, 1, 4];
i++;

talent[i] = [1, "Improved Stings", 3, 2, 4];
i++;
talent[i] = [1, "Efficiency", 5, 3, 4];
i++;
talent[i] = [1, "Concussive Barrage", 2, 1, 5];
i++;
talent[i] = [1, "Readiness", 1, 2, 5];
i++;
talent[i] = [1, "Barrage", 3, 3, 5];
i++;
talent[i] = [1, "Combat Experience", 2, 1, 6];
i++;
talent[i] = [1, "Ranged Weapon Specialization", 3, 4, 6];
i++;
talent[i] = [1, "Piercing Shots", 3, 1, 7];
i++;
talent[i] = [1, "Trueshot Aura", 1, 2, 7, [getTalentID("Readiness"), 1]];
i++;
talent[i] = [1, "Improved Barrage", 3, 3, 7, [getTalentID("Barrage"), 3]];
i++;
talent[i] = [1, "Master Marksman", 5, 2, 8];
i++;
talent[i] = [1, "Rapid Recuperation", 2, 3, 8];
i++;
talent[i] = [1, "Wild Quiver", 3, 1, 9];
i++;
talent[i] = [1, "Silencing Shot", 1, 2, 9, [getTalentID("Master Marksman"), 5]];
i++;
talent[i] = [1, "Improved Steady Shot", 3, 3, 9];
i++;
talent[i] = [1, "Marked for Death", 5, 2, 10];
i++;
talent[i] = [1, "Rapid Shot", 1, 3, 10, [getTalentID("Improved Steady Shot"), 1]];
i++;
talent[i] = [1, "Chimera Shot", 1, 2, 11];
i++;
...
//survival talents
talent[i] = [2, "Improved Tracking", 5, 1, 1];
i++;
talent[i] = [2, "Hawk Eye", 3, 2, 1];
i++;
talent[i] = [2, "Savage Strikes", 2, 3, 1];
i++;
talent[i] = [2, "Surefooted", 3, 1, 2];
i++;
talent[i] = [2, "Entrapment", 3, 2, 2];
i++;
talent[i] = [2, "Trap Mastery", 3, 3, 2];
i++;
talent[i] = [2, "Survival Instincts", 2, 4, 2];
i++;
talent[i] = [2, "Survivalist", 5, 1, 3];
i++;
talent[i] = [2, "Scatter Shot", 1, 2, 3];
i++;
talent[i] = [2, "Deflection", 3, 3, 3];
i++;
talent[i] = [2, "Survival Tactics", 2, 4, 3];
i++;
talent[i] = [2, "T.N.T.", 3, 2, 4];
i++;
talent[i] = [2, "Lock and Load", 3, 4, 4];
i++;
talent[i] = [2, "Hunter vs. Wild", 3, 1, 5, [getTalentID("Survivalist"), 5]];
i++;
talent[i] = [2, "Killer Instinct", 3, 2, 5];
i++;
talent[i] = [2, "Counterattack", 1, 3, 5, [getTalentID("Deflection"), 3]];
i++;
talent[i] = [2, "Lightning Reflexes", 5, 1, 6];
i++;
talent[i] = [2, "Resourcefulness", 3, 3, 6];
i++;
talent[i] = [2, "Wildfire Infusion", 1, 4, 6, [getTalentID("Resourcefulness"), 4]];
i++;
talent[i] = [2, "Expose Weakness", 3, 1, 7, [getTalentID("Lightning Reflexes"), 5]];
i++;
talent[i] = [2, "Wyvern Sting", 1, 2, 7, [getTalentID("Killer Instinct"), 3]];
i++;
talent[i] = [2, "Thrill of the Hunt", 3, 3, 7];
i++;
talent[i] = [2, "Master Tactician", 5, 1, 8];
i++;
talent[i] = [2, "Noxious Stings", 3, 2, 8, [getTalentID("Wyvern Sting"), 1]];
i++;
talent[i] = [2, "Point of No Escape", 2, 1, 9];
i++;
talent[i] = [2, "Black Arrow", 1, 2, 9];
i++;
talent[i] = [2, "Sniper Training", 3, 4, 9];
i++;
talent[i] = [2, "Hunting Party", 3, 3, 10, [getTalentID("Thrill of the Hunt"), 3]];
i++;
talent[i] = [2, "Find Weakness", 1, 4, 10, [getTalentID("Sniper Training"), 1]];
i++;
talent[i] = [2, "Explosive Shot", 1, 2, 11, [getTalentID("Black Arrow"), 1]];
i++;
talent[i] = [2, "Improved Lone Wolf", 1, 3, 11];
i++;
treeStartStop[t] = i - 1;
t++;

/*
  	Post adjustments for Poisonous shots
	- add 3 points in Improved Stings as a requirement
 */
talent[poisonousShotsId][5] = [getTalentID('Improved Stings'), 3];
...
//Animal's Mind - Beast Mastery

rank[i] = [
    "The Movement speed bonus is now active in any aspect and Aspect of the Cheetah and Pack increase movement speed by an additional 30% for 4 seconds. Cannot occur more often than once every 25 seconds."
];
i++;
...
i++;
// Cobra Charmer - Beast Mastery
rank[i] = [
    "Cobra Strikes now summon a poisonous Serpent which blasts your target for nature Damage over 12 seconds."
];
i++;
...
// Poisonous Shots - Marksmanship
rank[i] = [
    "Your ammunition is permanently drenched in a deadly mixture, causing your Arcane, Steady and Aimed shot to deal 10% additional Damage as Nature"
];
i++;
...
rank[i] = [
    "<span style=text-align:right;float:right;></span><br><span style=text-align:left;float:left;>Channeled</span><span style=text-align:right;float:right;>50 sec cooldown</span><br><br/>Cause the Hunter to focus, shooting rapidly at nearby enemies for 8 seconds.<br/>"
];
i++;
...
//Wildfire Infusion - Survival
rank[i] = [
    "Freezing, Frost and Explosive Trap empowers your next Wildfire Cluster or Explosive shot, granting it uniques effects for each trap."
];
i++;
...
//Find Weakness - Survival
rank[i] = [
    "<br><span style=text-align:left;float:left;>Instant</span><span style=text-align:right;float:right;>45 sec cooldown</span>While Standing still you have found a flaw in the enemies defense. Your next Explosive Shot or Lacerate cannot be missed, dodged or blocked and is infused with a Black Arrow. Find Weakness	can only be used while Sniper Training is active."
];
i++;
...
i++;
//Improved Lone Wolf - Survival
rank[i] = [
    "Lone Wolf increase your Damage dealt by an additionnal 3%"
];
i++;
