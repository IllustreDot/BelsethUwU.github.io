...
talent[i] = [0, "Animal's Mind",1,1,4, [getTalentID("Pathfinding"),2]]; i++;
...
talent[i] = [0, "Cobra Charmer", 1,4,9,[getTalentID("Cobra Strikes"),1]]; i++;
...
talent[i] = [1, "Poisonous Shots", 1,1,4]; const poisonousShotID = i; i++;
talent[i] = [1, "Improved Stings", 3, 2, 4]; i++;
talent[poisonousShotID][5] = [getTalentID("Improved Stings"),1];
...
talent[i] = [1, "Rapid Shot", 1, 3, 10,[getTalentID("Improved Steady Shot"),1]]; i++;
...
talent[i] = [2, "Wildfire Infusion", 1, 4, 6, [getTalentID("Resourcefulness"),4]]; i++;
...
talent[i] = [2, "Find Weakness",1,4,10,[getTalentID("Sniper Training"),1]]; i++;
talent[i] = [2, "Explosive Shot", 1, 2, 11, [getTalentID("Black Arrow"),1]]; i++;
talent[i] = [2, "Improved Lone Wolf", 1, 3, 11]; i++;
treeStartStop[t] = i -1;
t++;
