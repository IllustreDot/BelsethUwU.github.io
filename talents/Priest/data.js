...
talent[i] = [0, "Improved Firestorm Kick", 1,4,6,[getTalentID("Enlightenment"),2]]; i++;
...
talent[i] = [0, "Scarlet Will", 1,4,8]; i++;
...
talent[i] = [1, "Light's Promise", 1, 4,7,[getTalentID("Blessed Resilience"),2]]; i++;
...
talent[i] = [2, "Shadowy Tome",1,4,6,[getTalentID("Focused Mind"),2]]; i++;
...
talent[i] = [2, "Searing Nightmares", 1, 4, 9,[getTalentID("Pain and Suffering"),2]]; i++;
